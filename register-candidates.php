...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>Par</b>TIM</span>
    </a>
          ...
          <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              <div class="form-group">
                <input class="form-control input-lg" type="text" minlength="4" id="fname" name="fname" placeholder="First Name *" required>
              </div>
              <div class="form-group">
                <input class="form-control input-lg" type="text" minlength="4" id="lname" name="lname" placeholder="Last Name *" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input class="form-control input-lg" type="date" id="dob" min="1990-01-01" max="1999-01-31" name="dob" placeholder="Date Of Birth">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input class="form-control input-lg" type="date" id="passingyear" min="2005-01-01" max="2019-01-31" name="passingyear" placeholder="Passing Year">
              </div>       
              <div class="form-group">
            ...
            <div class="col-md-6 latest-job ">
              <div class="form-group">
                <input class="form-control input-lg" type="password" minlength="5" id="password" name="password" placeholder="Password *" required>
              </div>
              <div class="form-group">
