          ...
          <form method="post" id="registerCompanies" action="addcompany.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              <div class="form-group">
                <input class="form-control input-lg" type="text" minlength="5" name="name" placeholder="Full Name" required>
              </div>
              <div class="form-group">
                <input class="form-control input-lg" type="text" minlength="5" name="companyname" placeholder="Company Name" required>
              </div>
              <div class="form-group">
            ...
            <div class="col-md-6 latest-job ">
              <div class="form-group">
                <input class="form-control input-lg" type="password" minlength="5" name="password" placeholder="Password" required>
              </div>
              <div class="form-group">
